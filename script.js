...
if (contactForm) {
    // Initialize EmailJS once SDK is available
    document.addEventListener('DOMContentLoaded', () => {
        if (window.emailjs && typeof emailjs.init === 'function') {
            // EmailJS Public Key
            emailjs.init('k4zTIVdcQoKkoepOP');
        }
    });
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const serviceId = 'service_235d44l';
            const templateId = 'template_mbmewpe';

            // Map template params to your EmailJS template variables
            const templateParams = {
                ...
                subject: subject,
                message: message,
                // Common aliases many default templates use
                reply_to: email,
                to_name: 'Deeksha',
                user_name: name,
                user_email: email,
